...
function Contacto() {
  ...
  return (
    <div className="text-center flex flex-col items-center justify-center h-[841px] ">
        <h2 className="text-black/80 font-bold text-5xl mb-28">Contactános</h2>
        <div className="w-full flex gap-4 items-center justify-center">
           <div className="flex w-2/6 flex-col md:flex-nowrap mb-6 md:mb-0 gap-4">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3283.527435998273!2d-58.4359707353868!3d-34.61610936447341!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcca4180e4bec9%3A0x9b4bd5d87c109119!2sEstablecimiento%20Geri%C3%A1trico%20Neuqu%C3%A9n!5e0!3m2!1ses!2sar!4v1707244939232!5m2!1ses!2sar" width="600" height="350" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>  
    </div>
  )
}
